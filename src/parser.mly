...
global_variable_declaration:
  ...
  | attribute_list VAR IDENTIFIER COLON bpf_type ASSIGN expression
    { make_global_var_decl $3 (Some $5) (Some $7) (make_pos ()) ~attrs:$1 () }
  | attribute_list VAR IDENTIFIER COLON bpf_type
    { make_global_var_decl $3 (Some $5) None (make_pos ()) ~attrs:$1 () }
  | attribute_list VAR IDENTIFIER ASSIGN expression
    { make_global_var_decl $3 None (Some $5) (make_pos ()) ~attrs:$1 () }
